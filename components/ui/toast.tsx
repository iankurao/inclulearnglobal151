...
import { ToastIcon } from "./toast-icon" // Assuming ToastIcon is defined in another file
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 right-0 flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:p-6",
      className,
    )}
    {...props}
  />
...
type ToasterProps = {
  ...
  limit?: number
  /**
   * Whether to pause the toast when the mouse is over it.
   * @default true
   */
  ...
  className?: string
  /**
   * The class name to apply to the viewport.
   */
  viewportClassName?: string
}

export { Toast, ToastProvider, ToastViewport, ToastIcon, ToastTitle, ToastDescription, ToastClose, ToastAction }
