...
const Toast = React.forwardRef<React.ElementRef<typeof Toast>, ToastProps>(
  ({ className, variant, children, ...props }, ref) => {
    const { toasts } = useToast()
    const toast = toasts.find((t) => t.id === props.id)
...
const ToastAction = React.forwardRef<React.ElementRef<typeof Toast.Action>, ToastActionElement>(
  ({ className, ...props }, ref) => (
    <Toast.Action
      ref={ref}
      className={cn(
